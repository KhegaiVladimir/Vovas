...
from .serializers import MovieSerializer, DirectorsInfoSerializer, ReviewSerializer, DirectorsSerializer, DirectorValidateSerializer, ReviewValidateSerializer
...
class DirectorListCreateAPIView(ListCreateAPIView):
    ...
    serializer_class = DirectorsInfoSerializer
    pagination_class = PageNumberPagination
